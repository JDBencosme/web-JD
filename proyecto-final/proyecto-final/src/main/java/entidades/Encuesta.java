...
public class Encuesta {
    ...
    public Encuesta(){}
    public Encuesta(String nombre, String sector, String nivelEscolar, Usuario user, String latitude, String longitude, String accuracy, Foto foto) {
        this.nombre = nombre;
        this.sector = sector;
